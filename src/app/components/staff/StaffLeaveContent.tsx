...
const leaveBalance = [
    { type: "Annual Leave", total: 14, used: 4, icon: <CalendarDays size={18} className="text-[#155DFC]" />, color: "#155DFC", bg: "bg-[#EFF6FF]" },
...
export function StaffLeaveContent() {
    ...
    return (
        <div className="space-y-[20px]">
            ...
            {/* Apply Leave Modal */}
            {showApply && (
                <div className="fixed inset-0 bg-black/30 z-50 flex items-center justify-center" onClick={() => setShowApply(false)}>
                    <div className="bg-white rounded-[16px] w-[480px] shadow-xl" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="p-[24px] space-y-[16px]">
                            ...
                            <div>
                                ...
                                <div className="border-2 border-dashed border-[#E5E7EB] rounded-[8px] p-[16px] text-center hover:border-[#155DFC] transition-colors cursor-pointer">
                                    <p className="font-['Inter',sans-serif] text-[12px] text-[#9CA3AF]">
                                        Drop file here or <span className="text-[#155DFC]">browse</span>
                                    </p>
